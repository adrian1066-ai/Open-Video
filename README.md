...
## Run locally
Open `index.html` in a browser. No npm, server, database or API keys are required.

## Included prototype flows
- Home / Explore / category filtering / search
- Video watch page
- Like / Follow / Comment
...
- Creator Wallet
- Payout method setup (simulated)
- Tax / identity verification status (simulated)
- Transaction history
- Promote Video flow
- OpenVideo Premium
- Creator Pro
...
- FULL ADS / LIMITED ADS / NO ADS content monetization states
